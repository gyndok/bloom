...
test('calendar exports milestone events and eight care windows',()=>{const text=calendar(calculate(base));assert.equal((text.match(/BEGIN:VEVENT/g)||[]).length,17);assert.match(text,/DTSTART;VALUE=DATE:20241007\r\nDTEND;VALUE=DATE:20241008/);assert.ok(text.endsWith('END:VCALENDAR\r\n'))});
